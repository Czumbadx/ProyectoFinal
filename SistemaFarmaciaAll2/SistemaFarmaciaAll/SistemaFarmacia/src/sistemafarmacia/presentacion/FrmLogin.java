...
public class FrmLogin extends javax.swing.JFrame {
    ...
    public FrmLogin() {
        ...
        ImageIcon icoLogin = new ImageIcon(iconoAdmin.getImage().getScaledInstance(lblPresentacion.getWidth(), lblPresentacion.getHeight(), Image.SCALE_DEFAULT));
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
        ...
        try {
            ...
            usuario = UsuarioDAT.login(usuario);
            if(usuario!=null){
